 ...
 * 文件：com.cslc.ump.dataImport.fileParser.TxtFileParser.java
 * 所含类: TxtFileParser.java
 * 修改记录：
 * 日期                           作者                            内容
 * =============================================================
...
public class TXTFileParser implements FileParser {
	private static final Logger log = LoggerFactory.getLogger(TXTFileParser.class);
	// 文件
	private File file;
	// 分隔符 默认为逗号
	 ...
	 * @param startLine
	 */
	public TXTFileParser(File file, String separator, String startLineMarker) {
		this.file = file;
