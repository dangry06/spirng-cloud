...
public class FileSystemStorageService implements StorageService {
    ...
    @Override
    public void store(String subdir, MultipartFile file) {
        ...
        try {
            ...
            Path uploadPath = this.rootLocation.resolve(subdir);
    ...
    public Path load(String subdir, String filename) {
        return this.rootLocation.resolve(subdir).resolve(filename);
    }
